...
function resolve_backoffice_asset_path($p) {
    if (empty($p)) return '';
    $p = trim($p);
    if (preg_match('#^(https?:)?//#', $p) || strpos($p, '/') === 0) return $p;
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <?php if (!empty($ingrediant['img_ing'])): ?>
                                                                                        <img src="<?php echo htmlspecialchars(resolve_backoffice_asset_path($ingrediant['img_ing'])); ?>" alt="Ingrediant image" style="width:60px;height:60px;object-fit:cover;border-radius:6px;">
                                                                                    <?php else: ?>
                                                                                        No image
                                                                                    <?php endif; ?>
                                                                                </td>
