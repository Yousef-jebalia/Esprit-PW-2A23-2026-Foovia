                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <?php if (!empty($recipe['img_rec'])): ?>
                                                                                        <img src="<?php echo htmlspecialchars(resolve_backoffice_asset_path($recipe['img_rec'])); ?>" alt="Recipe image" style="width:60px;height:60px;object-fit:cover;border-radius:6px;">
                                                                                    <?php else: ?>
                                                                                        No image
                                                                                    <?php endif; ?>
                                                                                </td>
