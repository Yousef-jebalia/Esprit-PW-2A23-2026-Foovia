<?php
include __DIR__ . '/../../../MVC/Controller/Thread_Controller.php';
                      ...
                      <div class="col-sm-12 col-md-7">
                        <div class="card">
                          <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <a href="../../View/front_office/threads_page.php"
                                  ...
                                  <?php if (!empty($threads)): ?>
                                    <?php foreach ($threads as $t): ?>
                                      <tr>
                                        ...
                                        <td>
                                          <a href="../../View/front_office/thread_detail_page.php?id=<?php echo (int) $t['id_thread']; ?>"
