...
<?php
include '../../Controller/Reclamtion_Controller.php';
              ...
              <article class="support-team-card" tabindex="0" aria-label="Sara Mezzi, Head of Support, sara.mezzi@foovia.com, +216 55 100 077">
                <div class="support-team-card__surface">
                  ...
                  <div class="support-team-card__drawer">
                    ...
                    <p class="small mb-1"><a href="mailto:sara.mezzi@foovia.com">bob@foovia.com</a></p>
                    <p class="small mb-0 text-body">+216 00000000</p>
                  </div>
                </div>
              </article>
            </div>
              ...
              <article class="support-team-card" tabindex="0" aria-label="Karim Ben Salah, Claims specialist, karim.bensalah@foovia.com, +216 98 203 040">
                <div class="support-team-card__surface">
                  ...
                  <div class="support-team-card__drawer">
                    ...
                    <p class="small text-muted mb-2">Claims specialist</p>
                    <p class="small mb-1"><a href="mailto:karim.bensalah@foovia.com">salah@foovia.com</a></p>
                    <p class="small mb-0 text-body">+216 10 100 100</p>
                  </div>
                </div>
              </article>
            </div>
              ...
              <article class="support-team-card" tabindex="0" aria-label="Leïla Oueslati, Customer success, leila.oueslati@foovia.com, +216 22 114 455">
                <div class="support-team-card__surface">
                  ...
                  <div class="support-team-card__drawer">
                    ...
                    <p class="small text-muted mb-2">Customer success</p>
                    <p class="small mb-1"><a href="mailto:leila.oueslati@foovia.com">x@foovia.com</a></p>
                    <p class="small mb-0 text-body">+216 22 22 22 22</p>
                  </div>
                </div>
              </article>
            </div>
