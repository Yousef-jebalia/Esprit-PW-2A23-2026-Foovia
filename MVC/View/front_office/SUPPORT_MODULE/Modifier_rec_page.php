    ...
    <section class="py-6 text-white" style="background: linear-gradient(180deg, rgba(27, 79, 43, .75), rgba(27, 79, 43, .35)), url('images/banner-1.jpg') center/cover no-repeat;">
      <div class="container py-5">
        <div class="row align-items-center">
          <div class="col-lg-7">
            <p class="text-uppercase small mb-3">Edit claim</p>
            <h1 class="display-5 fw-bold mb-3">Update your support request in seconds.</h1>
            <p class="lead mb-4">Adjust your claim details below and save changes for fast follow-up.</p>
            <div class="d-flex flex-wrap gap-2">
              <a href="support_rec_page.php" class="btn btn-light btn-lg">Back to claims</a>
              <a href="add_rec_page.php" class="btn btn-outline-light btn-lg">New claim</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section>
        ...
        <form action="" method="post" class="container mt-5" novalidate>
          ...
          <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="support_rec_page.php" class="btn btn-secondary" title="Back">Back</a>
            </div>
        </form>
      </section>
