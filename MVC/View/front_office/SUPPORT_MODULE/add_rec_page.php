...
<html lang="en">
  <head>
    ...
    <style>
      .support-rec-body-form { background-color: #fff; }
      html[data-theme="dark"] .support-rec-body-form { background-color: var(--bs-body-bg, #1a1a1a); color: var(--bs-body-color, #e0e0e0); }
  ...
  <body class="support-rec-body-form">
      ...
      <div class="container py-4">
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-between gap-3">
          <a href="support_rec_page.php" class="d-flex align-items-center gap-2 text-decoration-none">
            ...
            <span class="h4 mb-0 text-body fw-bold">Foovia</span>
          </a>
    ...
    <section class="py-6 text-white" style="background: linear-gradient(180deg, rgba(27, 79, 43, .75), rgba(27, 79, 43, .35)), url('images/banner-1.jpg') center/cover no-repeat;">
      <div class="container py-5">
        <div class="row align-items-center">
          <div class="col-lg-7">
            <p class="text-uppercase small mb-3">Submit a claim</p>
            <h1 class="display-5 fw-bold mb-3">Tell us what went wrong. Our support team is ready to help.</h1>
            ...
            <div class="d-flex flex-wrap gap-2">
              ...
              <span class="btn btn-outline-light btn-lg disabled" aria-disabled="true">Signed in as <?php echo htmlspecialchars($logged_in_user_name); ?></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section>
        ...
        <form action="" method="post" class="container mt-5" novalidate>
          ...
          <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="support_rec_page.php" class="btn btn-secondary" title="Cancel">Return</a>
        </form>
      </section>
