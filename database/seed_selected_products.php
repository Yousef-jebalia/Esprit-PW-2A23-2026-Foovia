...
$products = [
    [
        ...
        'expires' => '2026-05-08',
        'point' => 'F1',
        'image' => __DIR__ . '/../View/assets/products/oranges.jpg',
        'stores' => [1, 2, 3, 4, 5],
        'categories' => [1],
    ],
    [
        ...
        'expires' => '2026-05-20',
        'point' => 'V2',
        'image' => __DIR__ . '/../View/assets/products/potatoes.webp',
        'stores' => [1, 2, 4, 5],
        'categories' => [2],
    ],
    [
        ...
        'expires' => '2026-05-06',
        'point' => 'F2',
        'image' => __DIR__ . '/../View/assets/products/banana.jpg',
        'stores' => [1, 3, 4, 5],
        'categories' => [1],
    ],
    [
        ...
        'expires' => '2026-05-02',
        'point' => 'M1',
        'image' => __DIR__ . '/../View/assets/products/steak.jpg',
        'stores' => [2, 3, 5],
        'categories' => [4],
    ],
    [
        ...
        'expires' => '2026-05-07',
        'point' => 'V1',
        'image' => __DIR__ . '/../View/assets/products/tomato.jpg',
        'stores' => [1, 2, 3, 4, 5],
        'categories' => [2],
    ],
];
